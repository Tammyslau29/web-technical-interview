...
import { HomesReducer, setSelectedHome } from "../../reducers/HomesReducer";
...
export const HomeCard = ({ home, handleSetHome }: HomeCardProp) => {
    const { address, id, zipCode, city, state, yearBuilt, bedrooms, bathrooms, sqft } = home
        ...
        <div className="max-w-sm mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            <div style={{ backgroundColor: 'white' }} className="bg-white h-30 flex-row justify-between shadow-lg rounded-lg relative bottom-10 p-4">
                <div className="justify-between flex">
                    ...
                    <button style={{ height: "30px", width: "30px" }} className="bg-primary text-white" onClick={() => handleSetHome(home)}>→</button>
